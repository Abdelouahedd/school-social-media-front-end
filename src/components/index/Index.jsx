                ...
                <div className="row d-flex">
                            ...
                            <div className="col-md-12">
                                <div className="blog-entry ftco-animate d-md-flex">
                                    ...
                                    <div className="text text-2 pl-md-4">
                                        ...
                                        <div className="meta-wrap">
                                            <p className="meta">
                                                ...
                                                <span><a href="single.html"><i
                                                    className="icon-folder-o mr-2"/>Travel</a></span>
                                        ...
                                        <p>
                                            <a href="#" className="btn-custom">Read More<span
                            ...
                            <div className="col-md-12">
                                <div className="blog-entry ftco-animate d-md-flex">
                                    ...
                                    <div className="text text-2 pl-md-4">
                                        ...
                                        <p>
                                            <a href="#" className="btn-custom">Read More <span
                                                className="ion-ios-arrow-forward"/></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="blog-entry ftco-animate d-md-flex">
                                    ...
                                    <div className="text text-2 pl-md-4">
                                        ...
                                        <p className="mb-4">A small river named Duden flows by their place and supplies
                                            it with the necessary regelialia.</p>
                                        <p>
                                            <a href="#" className="btn-custom">Read More
                                                <span className="ion-ios-arrow-forward"/></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="blog-entry ftco-animate d-md-flex">
                                    ...
                                    <div className="text text-2 pl-md-4">
                                        ...
                                        <p className="mb-4">A small river named Duden flows by their place and supplies
                                            it with the necessary regelialia.</p>
                                        <p><a href="#" className="btn-custom">Read More <span
                                            className="ion-ios-arrow-forward"/></a></p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-12">
                    ...
                    <div className="col-xl-4 sidebar ftco-animate bg-light pt-5">
                        ...
                        <div className="sidebar-box subs-wrap img py-4"
                             style={{backgroundImage: `url(${process.env.REACT_APP_URL}/images/bg_1.jpg)`}}>
