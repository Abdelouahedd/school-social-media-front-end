        ...
        <>
            ...
            <div className="theme-layout">
                    ...
                    <div className="mh-head first Sticky">
                        ...
                        <span className="mh-text">
                                <a href="newsfeed.html" title="">
                                    <img src={`${REACT_APP_URL}/images/logo2.png`} alt=""/>
                                </a>
                            </span>
                ...
                <div className="topbar stick">
                    <div className="logo">
                        <a title="" href="newsfeed.html"><img src={`${REACT_APP_URL}/images/logo2.png`} alt=""/></a>
                    </div>
                    ...
                    <div className="top-area">
                        ...
                        <ul className="setting-area">
                                    ...
                                    <ul className="drops-menu">
                                        <li>
                                            <a href="notifications.html" title="">
                                                <img src={`${REACT_APP_URL}/images/resources/thumb-1.jpg`} alt=""/>
                                        ...
                                        <li>
                                            <a href="notifications.html" title="">
                                                <img src={`${REACT_APP_URL}images/resources/thumb-2.jpg`} alt=""/>
                                                <div className="mesg-meta">
                                                    <h6>Jhon doe</h6>
                                                    <span>Hi, how r u dear ...?</span>
                                                    <i>2 min ago</i>
                                        ...
                                        <li>
                                            <a href="notifications.html" title="">
                                                <img src={`${REACT_APP_URL}/images/resources/thumb-3.jpg`} alt=""/>
                                                <div className="mesg-meta">
                                                    <h6>Andrew</h6>
                                                    <span>Hi, how r u dear ...?</span>
                                                    <i>2 min ago</i>
                                        ...
                                        <li>
                                            <a href="notifications.html" title="">
                                                <img src={`${REACT_APP_URL}/images/resources/thumb-4.jpg`} alt=""/>
                                                <div className="mesg-meta">
                                                    <h6>Tom cruse</h6>
                                                    <span>Hi, how r u dear ...?</span>
                                                    <i>2 min ago</i>
                                        ...
                                        <li>
                                            <a href="notifications.html" title="">
                                                <img src={`${REACT_APP_URL}/images/resources/thumb-5.jpg`} alt=""/>
                                                <div className="mesg-meta">
                                                    <h6>Amy</h6>
                                                    <span>Hi, how r u dear ...?</span>
                                                    <i>2 min ago</i>
                            ...
                            <li>
                                <a href="#" title="Messages" data-ripple=""><i
                                    className="ti-comment"/><span>12</span></a>
                                <div className="dropdowns">
                        ...
                        <div className="user-img">
                            <img src={`${REACT_APP_URL}/images/resources/admin.jpg`} alt=""/>
                        ...
                        <ul className="chat-users">
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}/images/resources/side-friend1.jpg`} alt=""/>
                                    <span className="status f-online"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}/images/resources/side-friend2.jpg`} alt=""/>
                                    <span className="status f-away"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}/images/resources/side-friend3.jpg`} alt=""/>
                                    <span className="status f-online"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}/images/resources/side-friend4.jpg`} alt=""/>
                                    <span className="status f-offline"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}/images/resources/side-friend5.jpg`} alt=""/>
                                    <span className="status f-online"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}/images/resources/side-friend6.jpg`} alt=""/>
                                    <span className="status f-online"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}/images/resources/side-friend7.jpg`} alt=""/>
                                    <span className="status f-offline"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}images/resources/side-friend8.jpg`} alt=""/>
                                    <span className="status f-online"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}images/resources/side-friend9.jpg`} alt=""/>
                                    <span className="status f-away"/>
                                </div>
                            </li>
                            <li>
                                <div className="author-thmb">
                                    <img src={`${REACT_APP_URL}images/resources/side-friend10.jpg`} alt=""/>
                                    <span className="status f-away"/>
                                </div>
                            </li>
                            <li>
						...
						<span className="more-optns"><i className="ti-more-alt"/>
                            ...
                            <div className="chat-list">
                                <ul>
                                    <li className="me">
                                        <div className="chat-thumb"><img
                                            src={`${REACT_APP_URL}images/resources/chatlist1.jpg`} alt=""/>
                                        </div>
								...
								<span className="chat-message-item">
                                    ...
                                    <li className="you">
                                        <div className="chat-thumb"><img
                                            src={`${REACT_APP_URL}images/resources/chatlist2.jpg`} alt=""/>
                                        </div>
                                        <div className="notification-event">
								<span className="chat-message-item">
									Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and Jake’s gonna get the drinks
                ...
                <div className="fixed-sidebar left">
                    <div className="menu-left">
                        <ul className="left-menu">
                            <li><a href="newsfeed.html" title="Newsfeed Page" data-toggle="tooltip"
                                   data-placement="right"><i className="ti-magnet"></i></a></li>
                            <li><a href="fav-page.html" title="favourit page" data-toggle="tooltip"
                                   data-placement="right"><i className="fa fa-star-o"></i></a></li>
                            <li><a href="insights.html" title="Account Stats" data-toggle="tooltip"
                                   data-placement="right"><i className="ti-stats-up"></i></a></li>
                            <li><a href="inbox.html" title="inbox" data-toggle="tooltip" data-placement="right"><i
                                className="ti-import"></i></a></li>
                            <li><a href="messages.html" title="Messages" data-toggle="tooltip" data-placement="right"><i
                                className="ti-comment-alt"></i></a></li>
                            <li><a href="edit-account-setting.html" title="Setting" data-toggle="tooltip"
                                   data-placement="right"><i className="ti-panel"></i></a></li>
                            <li><a href="faq.html" title="Faq's" data-toggle="tooltip" data-placement="right"><i
                                className="ti-light-bulb"></i></a></li>
                            <li><a href="timeline-friends.html" title="Friends" data-toggle="tooltip"
                                   data-placement="right"><i className="ti-themify-favicon"></i></a></li>
                            <li><a href="widgets.html" title="Widgets" data-toggle="tooltip" data-placement="right"><i
                                className="ti-eraser"></i></a></li>
                            <li><a href="notifications.html" title="Notification" data-toggle="tooltip"
                                   data-placement="right"><i className="ti-bookmark-alt"></i></a></li>
                        </ul>
                    </div>
                </div>
                {/* left sidebar menu*/}
                                            ...
                                            <aside className="sidebar static">
                                                ...
                                                <div className="widget stick-widget">
                                                    ...
                                                    <ul className="followers">
                                                        <li>
                                                            <figure><img
                                                                src={`${REACT_APP_URL}images/resources/friend-avatar2.jpg`}
                                                                alt=""/>
                                                            </figure>
                                                        ...
                                                        <li>
                                                            <figure><img
                                                                src={`${REACT_APP_URL}images/resources/friend-avatar4.jpg`}
                                                                alt=""/>
                                                            </figure>
                                                            <div className="friend-meta">
                                                        ...
                                                        <li>
                                                            <figure><img
                                                                src={`${REACT_APP_URL}images/resources/friend-avatar6.jpg`}
                                                                alt=""/>
                                                            </figure>
                                                            <div className="friend-meta">
                                                        ...
                                                        <li>
                                                            <figure><img
                                                                src={`${REACT_APP_URL}images/resources/friend-avatar8.jpg`}
                                                                alt=""/>
                                                            </figure>
                                                            <div className="friend-meta">
                                                        ...
                                                        <li>
                                                            <figure><img
                                                                src={`${REACT_APP_URL}images/resources/friend-avatar3.jpg`}
                                                                alt=""/>
                                                            </figure>
                                                            <div className="friend-meta">
                                                ...
                                                <div className="central-meta item">
                                                    <div className="user-post">
                                                        <div className="friend-info">
                                                            <figure>
                                                                <img
                                                                    src={`${REACT_APP_URL}images/resources/friend-avatar10.jpg`}
                                                                    alt=""/>
                                                            </figure>
                                                            ...
                                                            <div className="post-meta">
                                                                <img
                                                                    src={`${REACT_APP_URL}images/resources/user-post.jpg`}
                                                                    alt=""/>
															...
															<span className="dislike" data-toggle="tooltip"
                                                                ...
                                                                <div className="description">
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        !</a> the
                                                                        most beatuiful car available in america and
                                                                        the
                                                                        saudia arabia, you can book your test drive
                                                                        by
                                                            ...
                                                            <ul className="we-comet">
                                                                <li>
                                                                    <div className="comet-avatar">
                                                                        <img
                                                                            src={`${REACT_APP_URL}images/resources/comet-1.jpg`}
                                                                            alt=""/>
                                                                    </div>
                                                                    <div className="we-comment">
                                                                        <div className="coment-head">
                                                                            ...
                                                                            <a className="we-reply" href="#"
                                                                               title="Reply"><i
                                                                                className="fa fa-reply"/></a>
                                                                        </div>
                                                                        <p>we are working for the dance and sing songs.
                                                                            this
                                                                            car is very awesome for the youngster.
                                                                            please
                                                                    ...
                                                                    <ul>
                                                                        <li>
                                                                            <div className="comet-avatar">
                                                                                <img
                                                                                    src={`${REACT_APP_URL}images/resources/comet-2.jpg`}
                                                                                    alt=""/>
                                                                            </div>
                                                                            <div className="we-comment">
                                                                                <div className="coment-head">
                                                                        ...
                                                                        <li>
                                                                            <div className="comet-avatar">
                                                                                <img
                                                                                    src={`${REACT_APP_URL}images/resources/comet-3.jpg`}
                                                                                    alt=""/>
                                                                            </div>
                                                                            <div className="we-comment">
                                                                                <div className="coment-head">
                                                                ...
                                                                <li>
                                                                    <div className="comet-avatar">
                                                                        <img
                                                                            src={`${REACT_APP_URL}images/resources/comet-4.jpg`}
                                                                            alt=""/>
                                                                    </div>
                                                                    <div className="we-comment">
                                                                        <div className="coment-head">
                                                ...
                                                <div className="central-meta item">
                                                    <div className="user-post">
                                                        <div className="friend-info">
                                                            <figure>
                                                                <img
                                                                    src={`${REACT_APP_URL}images/resources/nearly1.jpg`}
                                                                    alt=""/>
                                                            </figure>
                                                            <div className="friend-name">
                                                                <ins><a href="time-line.html" title="">Sara Grey</a>
                                                                </ins>
                                                                <span>published: june,2 2018 19:PM</span>
                                                            </div>
                                                            <div className="post-meta">

                                                                <iframe src="https://player.vimeo.com/video/277739637"
                                                                        width="" height="315" frameBorder="0"
                                                ...
                                                <div className="central-meta item">
                                                    <div className="user-post">
                                                        <div className="friend-info">
                                                            <figure>
                                                                <img
                                                                    src={`${REACT_APP_URL}images/resources/nearly6.jpg`}
                                                                    alt=""/>
                                                            </figure>
                                                            <div className="friend-name">
                                                        ...
                                                        <div className="friend-info">
                                                            ...
                                                            <div className="description">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    in
                                                                    america and the saudia arabia, you can book your
                                                                    test
                                                            ...
                                                            <div className="post-meta">
                                                                <div className="linked-image align-left">
                                                                    <a title="" href="#">
                                                                        <img
                                                                            src={`${REACT_APP_URL}images/resources/page1.jpg`}
                                                                            alt=""/>
                                                                    </a>
                                                                </div>
                                            ...
                                            <aside className="sidebar static">
                                                <div className="widget">
                                                    ...
                                                    <div className="your-page">
                                                        <figure>
                                                            <a href="#" title=""><img
                                                                src={`${REACT_APP_URL}images/resources/friend-avatar9.jpg`}
                                                                alt=""/></a>
                                                        </figure>
                                                                ...
                                                                <div className="tab-pane active fade show " id="link1">
                                                                    ...
                                                                    <div className="users-thumb-list">
                                                                        <a href="#" title="Anderw"
                                                                           data-toggle="tooltip">
                                                                            <img
                                                                                src={`${REACT_APP_URL}images/resources/userlist-1.jpg`}
                                                                                alt=""/>
                                                                        </a>
                                                                        <a href="#" title="frank" data-toggle="tooltip">
                                                                            <img
                                                                                src={`${REACT_APP_URL}images/resources/userlist-2.jpg`}
                                                                                alt=""/>
                                                                        </a>
                                                                        <a href="#" title="Sara" data-toggle="tooltip">
                                                                            <img
                                                                                src={`${REACT_APP_URL}images/resources/userlist-3.jpg`}
                                                                                alt=""/>
                                                                        </a>
                                                                        <a href="#" title="Amy" data-toggle="tooltip">
                                                                            <img
                                                                                src={`${REACT_APP_URL}images/resources/userlist-4.jpg`}
                                                                                alt=""/>
                                                                        </a>
                                                                        <a href="#" title="Ema" data-toggle="tooltip">
                                                                            <img
                                                                                src={`${REACT_APP_URL}images/resources/userlist-5.jpg`}
                                                                                alt=""/>
                                                                        </a>
                                                                        <a href="#" title="Sophie"
                                                                           data-toggle="tooltip">
                                                                            <img
                                                                                src={`${REACT_APP_URL}images/resources/userlist-6.jpg`}
                                                                                alt=""/>
                                                                        </a>
                                                                        <a href="#" title="Maria" data-toggle="tooltip">
                                                                            <img
                                                                                src={`${REACT_APP_URL}images/resources/userlist-7.jpg`}
                                                                                alt=""/>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div className="tab-pane fade" id="link2">
                                                                    ...
                                                                    <div className="users-thumb-list">
                                                                        <a href="#" title="Anderw"
                                                                           data-toggle="tooltip">
                                                                            <img
                                                                                src={`${REACT_APP_URL}images/resources/userlist-1.jp`}
                                                                                alt=""/>
                                                                        </a>
                                                                        <a href="#" title="frank" data-toggle="tooltip">
                                                                            <img
                                                ...
                                                <div className="widget">
                                                    <div className="banner medium-opacity bluesh">
                                                        <div className="bg-image"
                                                             style={{backgroundImage: `url(${REACT_APP_URL}images/resources/baner-widgetbg.jpg)`}}></div>
                                                        <div className="baner-top">
                                                            <span><img alt=""
                                                                       src={`${REACT_APP_URL}images/book-icon.png`}/></span>
                                                ...
                                                <div className="widget friend-list stick-widget">
                                                    ...
                                                    <ul id="people-list" className="friendz-list">
                                                        <li>
                                                            <figure>
                                                                <img
                                                                    src={`${REACT_APP_URL}images/resources/friend-avatar.jpg`}
                                                                    alt=""/>
                                                            ...
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    ...
                                                                    data-cfemail="aed9c7c0dacbdcddc1c2cacbdceec9c3cfc7c280cdc1c3">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <figure>
                                                            ...
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    href="http://www.wpkixx.com/cdn-cgi/l/email-protection"
                                                                    className="__cf_email__"
                                                                    data-cfemail="ec8e8d9e82899fac8b818d8580c28f8381">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <figure>
                                                            ...
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    href="http://www.wpkixx.com/cdn-cgi/l/email-protection"
                                                                    className="__cf_email__"
                                                                    data-cfemail="5e343f2d31303c1e39333f3732703d3133">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <figure>
                                                            ...
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    href="http://www.wpkixx.com/cdn-cgi/l/email-protection"
                                                                    className="__cf_email__"
                                                                    data-cfemail="93f9f2e0fcfdf1d3f4fef2faffbdf0fcfe">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <figure>
                                                                <img
                                                                    src={`${REACT_APP_URL}images/resources/friend-avatar5.jpg`}
                                                                    alt=""/>
                                                                <span className="status f-online"></span>
                                                            </figure>
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    href="http://www.wpkixx.com/cdn-cgi/l/email-protection"
                                                                    className="__cf_email__"
                                                                    data-cfemail="6c060d1f03020e2c0b010d0500420f0301">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    href="http://www.wpkixx.com/cdn-cgi/l/email-protection"
                                                                    className="__cf_email__"
                                                                    data-cfemail="fa909b89959498ba9d979b9396d4999597">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <figure>
                                                                <img
                                                                    src={`${REACT_APP_URL}images/resources/friend-avatar7.jpg`}
                                                                    alt=""/>
                                                                <span className="status f-off"></span>
                                                            </figure>
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    href="http://www.wpkixx.com/cdn-cgi/l/email-protection"
                                                                    className="__cf_email__"
                                                                    data-cfemail="d3b9b2a0bcbdb193b4beb2babffdb0bcbe">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    href="http://www.wpkixx.com/cdn-cgi/l/email-protection"
                                                                    className="__cf_email__"
                                                                    data-cfemail="f09a91839f9e92b0979d91999cde939f9d">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <div className="friendz-meta">
                                                                ...
                                                                <i><a
                                                                    href="http://www.wpkixx.com/cdn-cgi/l/email-protection"
                                                                    className="__cf_email__"
                                                                    data-cfemail="4a282b38242f390a2d272b232664292527">[email&#160;protected]</a></i>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                    <div className="chat-box">
                                                        <div className="chat-head">
                                                            ...
                                                            <div className="more">
                                                                ...
                                                                <span className="close-mesage"><i
                                                                    className="ti-close"></i></span>
                                                            </div>
                                                        </div>
                                                        <div className="chat-list">
                                                            <ul>
                                                                <li className="me">
                                                                    <div className="chat-thumb"><img
                                                                        src={`${REACT_APP_URL}images/resources/chatlist1.jpg`}
                                                                        alt=""/>
                                                                    </div>
                                                                    <div className="notification-event">
															<span className="chat-message-item">
                                                                ...
                                                                <li className="you">
                                                                    <div className="chat-thumb"><img
                                                                        src={`${REACT_APP_URL}images/resources/chatlist2.jpg`}
                                                                        alt=""/>
                                                                    </div>
                                                                    <div className="notification-event">
															<span className="chat-message-item">
